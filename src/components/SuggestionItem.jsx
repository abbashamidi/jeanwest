...
export default function SuggestionItem({
  ...
  return (
    <div className="w-full rounded flex flex-col group min-w-[160px]">
      ...
      <div className="flex flex-col gap-2.5 py-2 px-3">
        <span className="text-xs line-clamp-2 break-words">{spancontent}</span>
