...
export default function Footer() {
  return (
    <div className="flex flex-col items-center justify-start w-[81.5%] mx-auto">
      <img src="./images/download.svg" alt="icon" className="h-48 w-48" />
      <span className="text-lg block -mt-16">
