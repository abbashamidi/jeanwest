        ...
        <ul className="flex items-center gap-7 grow">
          <HeaderForDesktopItem title={"جدیدترین"} icon={"fa-solid fa-fire"}>
            <div className="flex w-4/5 justify-evenly items-center mx-auto p-4 gap-4">
              <ImageButton title={'مردانه'} src={"/images/li-hover-divs/image1.jpg"} />
              <ImageButton title={'زنانه'} src={"/images/li-hover-divs/image2.jpg"} />
              <ImageButton title={'بچگانه'} src={"/images/li-hover-divs/image3.png"} />
            </div>
